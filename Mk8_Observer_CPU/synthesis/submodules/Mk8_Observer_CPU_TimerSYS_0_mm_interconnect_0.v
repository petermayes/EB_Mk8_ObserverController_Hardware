// Mk8_Observer_CPU_TimerSYS_0_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module Mk8_Observer_CPU_TimerSYS_0_mm_interconnect_0 (
	...
	wire  [80:0] timer_0_s1_agent_rf_source_data;                                                  // timer_0_s1_agent:rf_source_data -> timer_0_s1_agent_rsp_fifo:in_data
	...
	wire  [80:0] timer_0_s1_agent_rsp_fifo_out_data;                                               // timer_0_s1_agent_rsp_fifo:out_data -> timer_0_s1_agent:rf_sink_data
	...
	wire  [79:0] cmd_mux_src_data;                                                                 // cmd_mux:src_data -> timer_0_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                                // timer_0_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                              // cmd_mux:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire  [80:0] timer_1_s1_agent_rf_source_data;                                                  // timer_1_s1_agent:rf_source_data -> timer_1_s1_agent_rsp_fifo:in_data
	...
	wire  [80:0] timer_1_s1_agent_rsp_fifo_out_data;                                               // timer_1_s1_agent_rsp_fifo:out_data -> timer_1_s1_agent:rf_sink_data
	...
	wire  [79:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> timer_1_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                            // timer_1_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> timer_1_s1_agent:cp_channel
	...
	wire  [79:0] timer_0_s1_agent_rp_data;                                                         // timer_0_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [79:0] timer_1_s1_agent_rp_data;                                                         // timer_1_s1_agent:rp_data -> router_002:sink_data
	...
	Mk8_Observer_CPU_TimerSYS_0_mm_interconnect_0_router router (
