// Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0 (
	...
	wire  [87:0] parameter_gpio_s1_agent_rf_source_data;                                           // Parameter_GPIO_s1_agent:rf_source_data -> Parameter_GPIO_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] parameter_gpio_s1_agent_rsp_fifo_out_data;                                        // Parameter_GPIO_s1_agent_rsp_fifo:out_data -> Parameter_GPIO_s1_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                                // cmd_mux:src_valid -> Parameter_GPIO_s1_agent:cp_valid
	wire  [86:0] cmd_mux_src_data;                                                                 // cmd_mux:src_data -> Parameter_GPIO_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                                // Parameter_GPIO_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                                              // cmd_mux:src_channel -> Parameter_GPIO_s1_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                        // cmd_mux:src_startofpacket -> Parameter_GPIO_s1_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                          // cmd_mux:src_endofpacket -> Parameter_GPIO_s1_agent:cp_endofpacket
	...
	wire  [87:0] parameter_rx_ram_s1_agent_rf_source_data;                                         // Parameter_RX_RAM_s1_agent:rf_source_data -> Parameter_RX_RAM_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] parameter_rx_ram_s1_agent_rsp_fifo_out_data;                                      // Parameter_RX_RAM_s1_agent_rsp_fifo:out_data -> Parameter_RX_RAM_s1_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                            // cmd_mux_001:src_valid -> Parameter_RX_RAM_s1_agent:cp_valid
	wire  [86:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> Parameter_RX_RAM_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                            // Parameter_RX_RAM_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> Parameter_RX_RAM_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                    // cmd_mux_001:src_startofpacket -> Parameter_RX_RAM_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                      // cmd_mux_001:src_endofpacket -> Parameter_RX_RAM_s1_agent:cp_endofpacket
	...
	wire  [87:0] reset_s1_agent_rf_source_data;                                                    // Reset_s1_agent:rf_source_data -> Reset_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] reset_s1_agent_rsp_fifo_out_data;                                                 // Reset_s1_agent_rsp_fifo:out_data -> Reset_s1_agent:rf_sink_data
	...
	wire  [86:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> Reset_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                            // Reset_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> Reset_s1_agent:cp_channel
	...
	wire  [87:0] parameter_tx_ram_s1_agent_rf_source_data;                                         // Parameter_TX_RAM_s1_agent:rf_source_data -> Parameter_TX_RAM_s1_agent_rsp_fifo:in_data
	...
	wire  [87:0] parameter_tx_ram_s1_agent_rsp_fifo_out_data;                                      // Parameter_TX_RAM_s1_agent_rsp_fifo:out_data -> Parameter_TX_RAM_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                            // cmd_mux_003:src_valid -> Parameter_TX_RAM_s1_agent:cp_valid
	wire  [86:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> Parameter_TX_RAM_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                            // Parameter_TX_RAM_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> Parameter_TX_RAM_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                    // cmd_mux_003:src_startofpacket -> Parameter_TX_RAM_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                      // cmd_mux_003:src_endofpacket -> Parameter_TX_RAM_s1_agent:cp_endofpacket
	wire         mm_clock_crossing_bridge_0_m0_agent_cp_valid;                                     // mm_clock_crossing_bridge_0_m0_agent:cp_valid -> router:sink_valid
	wire  [86:0] mm_clock_crossing_bridge_0_m0_agent_cp_data;                                      // mm_clock_crossing_bridge_0_m0_agent:cp_data -> router:sink_data
	...
	wire         parameter_gpio_s1_agent_rp_valid;                                                 // Parameter_GPIO_s1_agent:rp_valid -> router_001:sink_valid
	wire  [86:0] parameter_gpio_s1_agent_rp_data;                                                  // Parameter_GPIO_s1_agent:rp_data -> router_001:sink_data
	wire         parameter_gpio_s1_agent_rp_ready;                                                 // router_001:sink_ready -> Parameter_GPIO_s1_agent:rp_ready
	wire         parameter_gpio_s1_agent_rp_startofpacket;                                         // Parameter_GPIO_s1_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         parameter_gpio_s1_agent_rp_endofpacket;                                           // Parameter_GPIO_s1_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire         parameter_rx_ram_s1_agent_rp_valid;                                               // Parameter_RX_RAM_s1_agent:rp_valid -> router_002:sink_valid
	wire  [86:0] parameter_rx_ram_s1_agent_rp_data;                                                // Parameter_RX_RAM_s1_agent:rp_data -> router_002:sink_data
	wire         parameter_rx_ram_s1_agent_rp_ready;                                               // router_002:sink_ready -> Parameter_RX_RAM_s1_agent:rp_ready
	wire         parameter_rx_ram_s1_agent_rp_startofpacket;                                       // Parameter_RX_RAM_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         parameter_rx_ram_s1_agent_rp_endofpacket;                                         // Parameter_RX_RAM_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [86:0] reset_s1_agent_rp_data;                                                           // Reset_s1_agent:rp_data -> router_003:sink_data
	...
	wire         parameter_tx_ram_s1_agent_rp_valid;                                               // Parameter_TX_RAM_s1_agent:rp_valid -> router_004:sink_valid
	wire  [86:0] parameter_tx_ram_s1_agent_rp_data;                                                // Parameter_TX_RAM_s1_agent:rp_data -> router_004:sink_data
	wire         parameter_tx_ram_s1_agent_rp_ready;                                               // router_004:sink_ready -> Parameter_TX_RAM_s1_agent:rp_ready
	wire         parameter_tx_ram_s1_agent_rp_startofpacket;                                       // Parameter_TX_RAM_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         parameter_tx_ram_s1_agent_rp_endofpacket;                                         // Parameter_TX_RAM_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [86:0] router_src_data;                                                                  // router:src_data -> mm_clock_crossing_bridge_0_m0_limiter:cmd_sink_data
	...
	wire  [86:0] mm_clock_crossing_bridge_0_m0_limiter_cmd_src_data;                               // mm_clock_crossing_bridge_0_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [86:0] rsp_mux_src_data;                                                                 // rsp_mux:src_data -> mm_clock_crossing_bridge_0_m0_limiter:rsp_sink_data
	...
	wire  [86:0] mm_clock_crossing_bridge_0_m0_limiter_rsp_src_data;                               // mm_clock_crossing_bridge_0_m0_limiter:rsp_src_data -> mm_clock_crossing_bridge_0_m0_agent:rp_data
	...
	wire         parameter_gpio_s1_agent_rdata_fifo_src_valid;                                     // Parameter_GPIO_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] parameter_gpio_s1_agent_rdata_fifo_src_data;                                      // Parameter_GPIO_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         parameter_gpio_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter:in_0_ready -> Parameter_GPIO_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                    // avalon_st_adapter:out_0_valid -> Parameter_GPIO_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                     // avalon_st_adapter:out_0_data -> Parameter_GPIO_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                    // Parameter_GPIO_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                    // avalon_st_adapter:out_0_error -> Parameter_GPIO_s1_agent:rdata_fifo_sink_error
	wire         parameter_rx_ram_s1_agent_rdata_fifo_src_valid;                                   // Parameter_RX_RAM_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] parameter_rx_ram_s1_agent_rdata_fifo_src_data;                                    // Parameter_RX_RAM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         parameter_rx_ram_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_001:in_0_ready -> Parameter_RX_RAM_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                // avalon_st_adapter_001:out_0_valid -> Parameter_RX_RAM_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                 // avalon_st_adapter_001:out_0_data -> Parameter_RX_RAM_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                // Parameter_RX_RAM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                // avalon_st_adapter_001:out_0_error -> Parameter_RX_RAM_s1_agent:rdata_fifo_sink_error
	...
	wire         parameter_tx_ram_s1_agent_rdata_fifo_src_valid;                                   // Parameter_TX_RAM_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] parameter_tx_ram_s1_agent_rdata_fifo_src_data;                                    // Parameter_TX_RAM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         parameter_tx_ram_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_003:in_0_ready -> Parameter_TX_RAM_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                // avalon_st_adapter_003:out_0_valid -> Parameter_TX_RAM_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                 // avalon_st_adapter_003:out_0_data -> Parameter_TX_RAM_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                // Parameter_TX_RAM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                // avalon_st_adapter_003:out_0_error -> Parameter_TX_RAM_s1_agent:rdata_fifo_sink_error
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_router router (
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_router_001 router_001 (
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_router_001 router_002 (
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_router_001 router_003 (
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_router_001 router_004 (
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                   //        clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                   //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                                   //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                                   //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                                   //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Mk8_Observer_CPU_Parameter_SYS_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                   //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
